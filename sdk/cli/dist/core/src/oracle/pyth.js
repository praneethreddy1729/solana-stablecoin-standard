...
exports.PYTH_FEED_IDS = void 0;
exports.fetchPythHermesPrice = fetchPythHermesPrice;
exports.fetchPythOnChainPrice = fetchPythOnChainPrice;
 ...
 */
async function fetchPythHermesPrice(feedId, hermesBaseUrl = DEFAULT_HERMES_URL, timeoutMs = DEFAULT_TIMEOUT_MS) {
 ...
 */
async function fetchPythOnChainPrice(connection, priceAccount) {
    ...
    if (magic !== PYTH_PRICE_ACCOUNT_MAGIC) {
        throw new Error(`Invalid Pyth price account: magic 0x${magic.toString(16)} != 0x${PYTH_PRICE_ACCOUNT_MAGIC.toString(16)}`);
    }
 ...
 */
function pythPriceToNumber(rawPrice, exponent) {
