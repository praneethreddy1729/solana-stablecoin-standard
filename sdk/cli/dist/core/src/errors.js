...
exports.SSS_TRANSFER_HOOK_ERRORS = exports.SSS_TOKEN_ERRORS = void 0;
exports.parseSSSError = parseSSSError;
/** SSS Token Program errors (codes 6000-6034) */
exports.SSS_TOKEN_ERRORS = {
...
exports.SSS_TRANSFER_HOOK_ERRORS = {
 ...
 */
function parseSSSError(error) {
    const code = extractErrorCode(error);
    if (code === null)
        return null;
    if (exports.SSS_TOKEN_ERRORS[code])
        return exports.SSS_TOKEN_ERRORS[code];
    if (exports.SSS_TRANSFER_HOOK_ERRORS[code])
        return exports.SSS_TRANSFER_HOOK_ERRORS[code];
    return null;
}
